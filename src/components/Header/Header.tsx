...
const Header: React.FC = () => {
    ...
    return (
        <header className={`py-4 px-10 flex-wrap mb-6 ${theme === "dark" ? "bg-stone-900" : "bg-stone-300"}`}>
            <div className='flex items-center justify-between max-w-screen-2xl mx-auto my-0'>
